...
```{r 2018, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "left", fig.height=3.5, fig.width=8, fig.cap="Ozone levels by month in 2018"}
...
```{r 2019, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "left", fig.height=3.5, fig.width=8, fig.cap="Ozone levels by month in 2019"}
