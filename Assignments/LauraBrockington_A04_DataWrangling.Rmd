...
#1c 
o3_2018 <- read.csv("./Data/Raw/EPAair_O3_NC2018_raw.csv", header=TRUE, stringsAsFactors = TRUE) #reading in datasets
o3_2019 <- read.csv("./Data/Raw/EPAair_O3_NC2019_raw.csv", header=TRUE, stringsAsFactors = TRUE)
pm25_2018 <- read.csv("./Data/Raw/EPAair_PM25_NC2018_raw.csv", header=TRUE, stringsAsFactors = TRUE)
pm25_2019 <- read.csv("./Data/Raw/EPAair_PM25_NC2019_raw.csv", header=TRUE, stringsAsFactors = TRUE)
#2 
...
#9
EPAair_spread <- pivot_wider(EPAair_combine_processed, names_from = nutrient, values_from = mean_AQI)
#10
dim(???) #calling dimensions of dataset
#11
