...
```{r DataExercise-1a}
high_temp_f <- c(63, 70, 71, 63, 51, 61, 64, 66, 73, 65)
low_temp_f <- c(41, 49, 59, 45, 32, 32, 40, 46, 52, 53)
```
...
```{r DataExercise-1c}
df_temps <- data.frame(high_temp_f, high_temp_c, low_temp_f, low_temp_c)
names(df_temps) <- c("High Temp F", "High Temp C", "Low Temp F", "Low Temp C")
df_temps
```
