...
glimpse(PeterPaul.chem.nutrients$month)
...
the_plot <- ggplot(PeterPaul.chem.nutrients,
...
Ex1_plot <- PeterPaul.chem.nutrients %>% 
  filter(depth == 0) %>% 
  ggplot(
    mapping = aes(
      x=daynum,
  ...
  labs(
    title = "Surface Temperature vs Day of Year by Year",
    x = "Day of year",
